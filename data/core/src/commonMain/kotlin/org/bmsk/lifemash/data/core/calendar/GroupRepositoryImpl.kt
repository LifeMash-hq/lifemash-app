...
internal class GroupRepositoryImpl(private val api: CalendarApi) : GroupRepository {
    ...
    override suspend fun getMyGroups(): List<Group> = api.getMyGroups().map { it.toDomain() }

    override suspend fun getGroup(groupId: String): Group = api.getGroup(groupId).toDomain()
