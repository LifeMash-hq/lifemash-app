...
interface CommentRepository {
    ...
    suspend fun createComment(groupId: String, eventId: String, content: String): Comment
    suspend fun deleteComment(groupId: String, eventId: String, commentId: String)
}
