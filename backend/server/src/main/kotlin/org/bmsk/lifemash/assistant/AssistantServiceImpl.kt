...
class AssistantServiceImpl(
    ...
    override suspend fun chat(
        ...
        val conversationId = if (request.conversationId != null) {
            val convUuid = UUID.fromString(request.conversationId)
            ...
            assistantRepository.createConversation(userUuid, title).let { UUID.fromString(it.id) }
        }
    ...
    override fun getConversations(userId: String, limit: Int, offset: Long): List<ConversationDto> =
        assistantRepository.getConversations(UUID.fromString(userId), limit, offset)
    ...
    override fun getUsage(userId: String, date: LocalDate?): UsageResponse {
        ...
        return usageRepository.getUsage(UUID.fromString(userId), targetDate)
    }
